...
features = pd.read_csv("C:/Datasetintership/features.csv")
train = pd.read_csv("C:/Datasetintership/train.csv")
stores = pd.read_csv("C:/Datasetintership/stores.csv")
test = pd.read_csv("C:/Datasetintership/test.csv")
sample_submission = pd.read_csv("C:/Datasetintership/sampleSubmission.csv")
...
feature_store = features.merge(stores, how='inner', on = "Stores")
train = train.merge(feature_store, how='inner', on=['Stores','Date','IsHoliday'])
test = test.merge(feature_store, how='inner', on={'Stores', 'Date', 'IsHoliday'})
